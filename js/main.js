...
Custom by arturaugusto@gmail.com
*/

var cred = window.prompt("CouchDB credentials (e.g.: user:pass@XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX-bluemix.cloudantnosqldb.appdomain.cloud/ocr), without https://");
var db = new PouchDB('https://'+cred);

var changes = db.changes({
  since: 'now',
  live: true,
  include_docs: true,
  filter: 'readouts/by_status',
